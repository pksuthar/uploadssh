...
Project("{FAE04EC0-301F-11D3-BF4B-00C04F79EFBC}") = "<%= name %>", "<%= name %>\<%= name %>.csproj", "{<%= projectGuid %>}"
EndProject
...
GlobalSection(SharedMSBuildProjectFiles) = preSolution
	ReactNative.Shared\ReactNative.Shared.projitems*{98efa5d4-a185-4971-ae77-3845e31b84ce}*SharedItemsImports = 4
...
EndGlobalSection
	...
	GlobalSection(ProjectConfigurationPlatforms) = postSolution
		{<%= projectGuid %>}.Debug|ARM.ActiveCfg = Debug|ARM
		{<%= projectGuid %>}.Debug|ARM.Build.0 = Debug|ARM
		{<%= projectGuid %>}.Debug|ARM.Deploy.0 = Debug|ARM
		...
		{<%= projectGuid %>}.Debug|x86.Deploy.0 = Debug|x86
		{<%= projectGuid %>}.DebugBundle|ARM.ActiveCfg = DebugBundle|ARM
		{<%= projectGuid %>}.DebugBundle|ARM.Build.0 = DebugBundle|ARM
		{<%= projectGuid %>}.DebugBundle|ARM.Deploy.0 = DebugBundle|ARM
		{<%= projectGuid %>}.DebugBundle|x64.ActiveCfg = DebugBundle|x64
		{<%= projectGuid %>}.DebugBundle|x64.Build.0 = DebugBundle|x64
		{<%= projectGuid %>}.DebugBundle|x64.Deploy.0 = DebugBundle|x64
		{<%= projectGuid %>}.DebugBundle|x86.ActiveCfg = DebugBundle|x86
		{<%= projectGuid %>}.DebugBundle|x86.Build.0 = DebugBundle|x86
		{<%= projectGuid %>}.DebugBundle|x86.Deploy.0 = DebugBundle|x86
		{<%= projectGuid %>}.Release|ARM.ActiveCfg = Release|ARM
		{<%= projectGuid %>}.Release|ARM.Build.0 = Release|ARM
		{<%= projectGuid %>}.Release|ARM.Deploy.0 = Release|ARM
		...
		{<%= projectGuid %>}.Release|x86.Deploy.0 = Release|x86
		{<%= projectGuid %>}.ReleaseBundle|ARM.ActiveCfg = ReleaseBundle|ARM
		{<%= projectGuid %>}.ReleaseBundle|ARM.Build.0 = ReleaseBundle|ARM
		{<%= projectGuid %>}.ReleaseBundle|ARM.Deploy.0 = ReleaseBundle|ARM
		{<%= projectGuid %>}.ReleaseBundle|x64.ActiveCfg = ReleaseBundle|x64
		{<%= projectGuid %>}.ReleaseBundle|x64.Build.0 = ReleaseBundle|x64
		{<%= projectGuid %>}.ReleaseBundle|x64.Deploy.0 = ReleaseBundle|x64
		{<%= projectGuid %>}.ReleaseBundle|x86.ActiveCfg = ReleaseBundle|x86
		{<%= projectGuid %>}.ReleaseBundle|x86.Build.0 = ReleaseBundle|x86
		{<%= projectGuid %>}.ReleaseBundle|x86.Deploy.0 = ReleaseBundle|x86
