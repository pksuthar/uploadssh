...
<Project xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <ItemGroup>
    ...
    <Compile Include="$(MSBuildThisFileDirectory)Animated\AnimatedNode.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Animated\AnimationDriver.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Animated\DecayAnimationDriver.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Animated\DiffClampAnimatedNode.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Animated\DivisionAnimatedNode.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Animated\EventAnimationDriver.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Animated\FrameBasedAnimationDriver.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Animated\InterpolationAnimatedNode.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Animated\MultiplicationAnimatedNode.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Animated\NativeAnimatedModule.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Animated\NativeAnimatedNodesManager.cs" />
    ...
    <Compile Include="$(MSBuildThisFileDirectory)Bridge\ILifecycleEventListener.cs" />
    ...
    <Compile Include="$(MSBuildThisFileDirectory)Bridge\JavaScriptModuleBase.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Bridge\JavaScriptModuleBase.Generated.cs" />
    ...
    <Compile Include="$(MSBuildThisFileDirectory)Bridge\NativeModuleBase.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Bridge\NativeModuleRegistry.cs" />
    ...
    <Compile Include="$(MSBuildThisFileDirectory)Bridge\Queue\LimitedConcurrencyTaskScheduler.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Bridge\Queue\MessageQueueThread.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Bridge\Queue\MessageQueueThreadExtensions.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Bridge\Queue\MessageQueueThreadKind.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Bridge\Queue\MessageQueueThreadSpec.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Bridge\Queue\ReactQueueConfiguration.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Bridge\Queue\ReactQueueConfigurationSpec.cs" />
    ...
    <Compile Include="$(MSBuildThisFileDirectory)Bridge\ReactMethodAttribute.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Bridge\ReflectionReactDelegateFactory.cs" />
    ...
    <Compile Include="$(MSBuildThisFileDirectory)Chakra\JavaScriptException.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Chakra\JavaScriptFatalException.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Chakra\JavaScriptMemoryAllocationCallback.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Chakra\JavaScriptMemoryEventType.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Chakra\JavaScriptNativeFunction.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Chakra\JavaScriptObjectFinalizeCallback.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Chakra\JavaScriptPropertyId.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Chakra\JavaScriptRuntime.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Chakra\JavaScriptRuntimeAttributes.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Chakra\JavaScriptRuntimeVersion.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Chakra\JavaScriptScriptException.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Chakra\JavaScriptSourceContext.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Chakra\JavaScriptThreadServiceCallback.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Chakra\JavaScriptUsageException.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Chakra\JavaScriptValue.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Chakra\JavaScriptValueType.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Chakra\Native.cs" />
    ...
    <Compile Include="$(MSBuildThisFileDirectory)DevSupport\DevInternalSettings.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)DevSupport\DevServerHelper.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)DevSupport\DevSupportManager.cs" />
    ...
    <Compile Include="$(MSBuildThisFileDirectory)IReactInstanceManager.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)IReactPackage.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)LifecycleState.cs" />
    ...
    <Compile Include="$(MSBuildThisFileDirectory)Modules\Network\IHttpClient.cs" />
    ...
    <Compile Include="$(MSBuildThisFileDirectory)UIManager\EdgeSpacing.cs" />
    ...
    <Compile Include="$(MSBuildThisFileDirectory)UIManager\EpsilonEqualityComparer.cs" />
    ...
    <Compile Include="$(MSBuildThisFileDirectory)UIManager\PanelViewParentManager.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)UIManager\PointerEvents.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)UIManager\PropertySetter.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)UIManager\ReactDefaultCompoundView.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)UIManager\ReactShadowNode.cs" />
    ...
    <Compile Include="$(MSBuildThisFileDirectory)UIManager\RootViewHelper.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)UIManager\RootViewManager.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)UIManager\ShadowNodeRegistry.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)UIManager\SimpleViewManager.cs" />
    ...
    <Compile Include="$(MSBuildThisFileDirectory)UIManager\UIImplementation.cs" />
    ...
    <Compile Include="$(MSBuildThisFileDirectory)Views\Text\ReactRunManager.cs" />
    ...
    <Compile Include="$(MSBuildThisFileDirectory)Views\TextInput\ReactTextBox.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Views\TextInput\ReactTextChangedEvent.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Views\TextInput\ReactTextInputBlurEvent.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Views\TextInput\ReactTextInputEndEditingEvent.cs" />
    <Compile Include="$(MSBuildThisFileDirectory)Views\TextInput\ReactTextInputFocusEvent.cs" />
