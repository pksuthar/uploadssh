    ...
    **/
    ...
    interface LoDashStatic {
        ...
        differenceBy<T>(
            array: T[]|List<T>,
            values?: T[]|List<T>,
            iteratee?: ByIterator<T, any>|string
        ): T[];
    ...
    // _.uniqWith
    interface UniqWithCustomizer<T> {
    ...
    interface LoDashStatic {
        ...
        uniqWith<T>(
            array: T[],
            comparator: UniqWithCustomizer<T>
        ): T[];
    }
    ...
    interface LoDashStatic {
        ...
        sortBy<T>(
            ...
            iteratees: (ByIterator<T, any>|string|Object)[]): T[];
    ...
    interface LoDashImplicitArrayWrapper<T> {
        ...
        * @see _.sortBy
        **/
        sortBy(iteratees: (ByIterator<T, any>|string|Object)[]): LoDashImplicitArrayWrapper<T>;
    ...
    type OrdersString = 'desc'|'asc'|string;
    ...
    interface LoDashStatic {
        ...
        orderBy<W extends Object, T>(
            collection: List<T>,
            iteratees: ByIterator<T, any>|string|W|(ByIterator<T, any>|string|W)[],
            orders?: OrdersString|OrdersString[]
        ): T[];
        ...
        orderBy<T>(
            collection: List<T>,
            iteratees: ByIterator<T, any>|string|Object|(ByIterator<T, any>|string|Object)[],
            orders?: OrdersString|OrdersString[]
        ): T[];
    ...
    interface LoDashImplicitWrapper<T> {
         ...
         */
        orderBy(
            iteratees: ByIterator<T, any>|string|(ByIterator<T, any>|string)[],
            orders?: OrdersString|OrdersString[]
        ): LoDashImplicitArrayWrapper<T>;
    }
    ...
    interface LoDashStatic {
        ...
        invertBy(
            object: Object,
            interatee?: ByIterator<any, any>|string
        ): Dictionary<string[]>;
        ...
        invertBy<T>(
            ...
            interatee?: ByIterator<T, any>|string
        ): Dictionary<string[]>;
    ...
    interface LoDashStatic {
        ...
        omitBy<TResult extends {}, T extends {}>(
            object: T,
            predicate: ByIterator<any, boolean>
        ): TResult;
    }
    ...
    interface LoDashExplicitWrapperBase<T, TWrapper> {
         ...
         * @see _.noConflict
         */
        noConflict(): LoDashExplicitObjectWrapper<_.LoDashStatic>;
    }
    ...
    interface ByIterator<T, TResult> {
        (value: T, _do_not_use_: {
            'WARNING: You are not given "key" as a second parameter': Date|Function|boolean;
        }): TResult;
    }
